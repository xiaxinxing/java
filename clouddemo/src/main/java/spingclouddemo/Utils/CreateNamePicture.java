...
public class CreateNamePicture {
    ...
    public static void main(String[] args) throws IOException {
        String name = "刘言曌爱罗琪";
        generateImg(name, "G:\\NewWorkSpace\\dailyreport\\src\\main\\resources\\static\\img\\imgs", name);
    }
    ...
    private static Color getRandomColor() {
        ...
        String[] beautifulColors2 =
                new String[]{	"95,94,186","200,70,64","85,170,103"};

        int len = beautifulColors2.length;
        Random random = new Random();
        String[] color = beautifulColors2[random.nextInt(len)].split(",");
